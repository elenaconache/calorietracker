...
mixin _$LoginState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, loading, enabled);

  @override
  String toString() {
    return 'LoginState(loading: $loading, enabled: $enabled)';
  }
}
...
abstract mixin class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool loading, bool enabled});
}
...
extension LoginStatePatterns on LoginState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(bool loading, bool enabled)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _LoginState() when $default != null:
        return $default(_that.loading, _that.enabled);
      case _:
        return orElse();
    }
  }
...
class _LoginState implements LoginState {
  const _LoginState({this.loading = false, this.enabled = false});
