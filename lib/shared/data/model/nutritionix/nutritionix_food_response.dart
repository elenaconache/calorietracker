...
import 'package:calorietracker/shared/data/model/nutritionix/nutritionix_nutrient.dart';
...
class NutritionixFoodResponse {
  ...
  double _getNutrientValue(Nutrient nutrient) =>
      !hasMeasurementInfo ? 0 : nutrients?.firstWhereOrNull((attribute) => attribute.matchesNutrient(nutrient: nutrient))?.value ?? 0;
